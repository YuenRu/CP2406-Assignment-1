...
public class Road {
    //Set the coordinates of the path yourself
    ...
    public ArrayList<Point> choose(int begin, int end) {
        //BSN-EHW
        //For turning roads, record the starting point, turning point, and ending point
        if (begin == 1 && end == 2) {
            RoadList.add(A); // A
            RoadList.add(R1); // R1
            RoadList.add(D); // D
        ...
        //BSN-BSS
        //For vehicles going straight, record the start point, exit at the traffic lights, and end point
        ...
        //EHW-BSN
        //For U-turn cars, record the coordinates of the inflection point
